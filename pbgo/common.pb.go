...
type Application struct {
	...
	// endpoints is a endpoint string.
...
func (x *Application) GetEndpoints() string {
	if x != nil {
		return x.Endpoints
	}
	return ""
...
var file_common_proto_rawDesc = []byte{
	...
	0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x22, 0x99, 0x02, 0x0a, 0x0b, 0x41, 0x70, 0x70,
	...
	0x75, 0x70, 0x49, 0x64, 0x12, 0x1c, 0x0a, 0x09, 0x65, 0x6e, 0x64, 0x70, 0x6f, 0x69, 0x6e, 0x74,
	0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x65, 0x6e, 0x64, 0x70, 0x6f, 0x69, 0x6e,
	0x74, 0x73, 0x12, 0x1a, 0x0a, 0x08, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x18, 0x05,
...
var file_common_proto_depIdxs = []int32{
	...
	15, // 6: pbgo.Application.created_at:type_name -> google.protobuf.Timestamp
	15, // 7: pbgo.Application.updated_at:type_name -> google.protobuf.Timestamp
	15, // 8: pbgo.Cluster.created_at:type_name -> google.protobuf.Timestamp
	15, // 9: pbgo.Cluster.updated_at:type_name -> google.protobuf.Timestamp
	2,  // 10: pbgo.Cluster.status:type_name -> pbgo.ClusterStatus
	10, // 11: pbgo.Cluster.conf:type_name -> pbgo.ClusterConf
	7,  // 12: pbgo.Cluster.app_groups:type_name -> pbgo.AppGroup
	0,  // 13: pbgo.SimpleResponse.code:type_name -> pbgo.Code
	5,  // 14: pbgo.SimpleResponse.error:type_name -> pbgo.Error
	0,  // 15: pbgo.IDsResponse.code:type_name -> pbgo.Code
	5,  // 16: pbgo.IDsResponse.error:type_name -> pbgo.Error
	0,  // 17: pbgo.IDResponse.code:type_name -> pbgo.Code
	5,  // 18: pbgo.IDResponse.error:type_name -> pbgo.Error
