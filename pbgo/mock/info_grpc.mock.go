...
func (m *MockInfoServiceClient) ValidateLabelUniqueness(ctx context.Context, in *pbgo.ValidateLabelUniquenessRequest, opts ...grpc.CallOption) (*pbgo.ValidateLabelUniquenessResponse, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
...
func (mr *MockInfoServiceClientMockRecorder) ValidateLabelUniqueness(ctx, in interface{}, opts ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{ctx, in}, opts...)
...
// ValidateLabelUniqueness mocks base method.
func (m *MockInfoServiceServer) ValidateLabelUniqueness(arg0 context.Context, arg1 *pbgo.ValidateLabelUniquenessRequest) (*pbgo.ValidateLabelUniquenessResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ValidateLabelUniqueness", arg0, arg1)
	ret0, _ := ret[0].(*pbgo.ValidateLabelUniquenessResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// ValidateLabelUniqueness indicates an expected call of ValidateLabelUniqueness.
func (mr *MockInfoServiceServerMockRecorder) ValidateLabelUniqueness(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ValidateLabelUniqueness", reflect.TypeOf((*MockInfoServiceServer)(nil).ValidateLabelUniqueness), arg0, arg1)
}
